...
def generate_sample(data, tokenizer, model, num=1, length=60, train=False, temperature=1, top_k=10, top_p=0.5, device=torch.device('cuda')):
    ...
    if not train:
        ...
        df.to_excel("./output/generated.xlsx", index=False)
